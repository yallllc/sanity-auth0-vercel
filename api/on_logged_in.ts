...
// https://github.com/sanity-io/community-studio/blob/1da49b1260c447ec0dadf16a1b42af2977184c43/api/verify-token.ts
  ...
  await auth0.handleCallback(req, res, {
    onUserLoaded: async (req, res, session, state) => {
      try {
        ...
        expires.setTime(
          expires.getTime() +
            parseInt(process.env.AUTH0_COOKIE_EXPIRY, 10) * 1000,
        );
